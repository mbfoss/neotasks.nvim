...
#
#   <!-- vimdoc-only
#   See |neotasks-configuration| for the full option list.
#   -->
#
# Needs pandoc. panvimdoc itself is fetched on first run
...
command -v pandoc >/dev/null || die "pandoc not found (install pandoc first)"
